...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class SocialWelExpController : Controller
    {
        // GET: /SocialWelfareExpense/
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadSocialWelfareExpense"].ToString();

            return View();
        }

        [HttpPost]
        public string SocialWelExpDocument(HttpPostedFileBase FileData)
        {
            try
            {
                //save main file
            ...
            //   string thumbPath = Path.Combine(Server.MapPath("../" + ConfigurationManager.AppSettings["socialWelExpPdf"].ToString()), uniqueFilename);
