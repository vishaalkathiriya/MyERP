...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class DDInPressMediaController : Controller
    {
        //
        // GET: /tblHRDDDInPressMedia/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadDDPressMedia"].ToString();
            return View();
            
        }

        [HttpPost]
        public string ddInPressDocument(HttpPostedFileBase FileData)
        {
            try
            {
                //save main file
