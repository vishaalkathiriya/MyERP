...
using System.Web.Mvc;
    ...
    [Audit]
    public class PPEIssueRegisterController : Controller
    {
        //
        // GET: /HRD/PPEIssueRegister/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadPPEIssueRegister"].ToString();
            return View();
        }
