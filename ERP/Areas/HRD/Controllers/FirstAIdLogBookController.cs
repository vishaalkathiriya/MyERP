...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class FirstAIdLogBookController : Controller
    {
        //
        // GET: /HRD/FirstAIdLogBook/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadFirstAIdLogBook"].ToString();
            return View();
        }
