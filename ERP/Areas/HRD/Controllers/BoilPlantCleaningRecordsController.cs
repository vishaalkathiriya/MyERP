...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class BoilPlantCleaningRecordsController : Controller
    {
        //
        // GET: /HRD/BoilPlantCleaning/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadBoilPlantCleaningRecords"].ToString();
            return View();
        }
        [HttpPost]
