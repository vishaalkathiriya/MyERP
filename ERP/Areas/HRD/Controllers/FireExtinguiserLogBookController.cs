...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class FireExtinguiserLogBookController : Controller
    {
     
        //
        // GET: /HRD/FireExtinguiserLogBook/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadFireExtenguiserLogBook"].ToString();
            return View();
        }
        [HttpPost]
