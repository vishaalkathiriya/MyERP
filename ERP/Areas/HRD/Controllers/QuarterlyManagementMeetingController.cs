...
namespace ERP.Areas.HRD.Controllers
{
    ...
    [Audit]
    public class QuarterlyManagementMeetingController : Controller
    {
        //
        // GET: /QuarterlyManagementMeeting/
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DocPdf = "../../" + ConfigurationManager.AppSettings["UploadQuarterlyMeeting"].ToString();
            return View();
        }

        [HttpPost]
        public string UploadMeetingDoc(HttpPostedFileBase FileData)
        {
            try
            {
                //save main file
