...
namespace ERP.Areas.Invoice.Controllers
{
    ...
    public class ConversationController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            ViewBag.TempUploadPath = "../../" + ConfigurationManager.AppSettings["TempUploadPath"].ToString();
            ViewBag.InvConversationImagePath = "../../" + ConfigurationManager.AppSettings["invConversationUploads"].ToString();
            ViewBag.InvInquiryImagePath = "../../" + ConfigurationManager.AppSettings["invInquiryUploads"].ToString();
            ViewBag.InvProposalImagePath = "../../" + ConfigurationManager.AppSettings["invProposalUploads"].ToString();
