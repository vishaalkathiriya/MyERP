(function ($) {
	...
	$.fn.daterangepicker = function(settings){
		...
		var options = $.extend({
			presetRanges: [
                ...
                { text: 'Current Week', dateStart: function () { return Date.parse('today').previous().monday(); }, dateEnd: 'today' },
                { text: 'Previous Week', dateStart: function () { return Date.parse('today').previous().monday().addDays(-7); }, dateEnd: function () { return Date.parse('today').previous().monday().addDays(-1); } },
                ...
                { text: 'Current Year', dateStart: function () { var x = Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' }
				//extras:
	...
	var datepickerOptions = {
	    ...
	    //rangeInput.val(fDate(Date.parse('today')));
